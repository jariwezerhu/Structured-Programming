...
class HUWebshop(object):
    ...
    def renderpackettemplate(self, template="homepage.html", packet={}):
        ...
        if template == "homepage.html":
            packet['r_products'] = self.recommendations(4, True, 'homepage')
    ...
    def recommendations(self, count, productid, page):
        ...
        resp = requests.get(self.recseraddress+"/"+session['profile_id']+"/"+str(count)+"/"+str(productid)+"/"+str(page))
    ...
    def productpage(self, cat1=None, cat2=None, cat3=None, cat4=None, page=1):
        ...
        return self.renderpackettemplate('products.html', {'products': prodlist, \
            ...
            'r_products':self.recommendations(4, True, 'productpage'), \
    ...
    def productdetail(self, productid):
        ...
        return self.renderpackettemplate('productdetail.html', {'product':product,\
            ...
            'r_products':self.recommendations(4, str(productid), 'product_details'), \
    ...
    def shoppingcart(self):
        ...
        return self.renderpackettemplate('shoppingcart.html',{'itemsincart':i,\
            'r_products':self.recommendations(4, True, 'shoppingcart'), \
